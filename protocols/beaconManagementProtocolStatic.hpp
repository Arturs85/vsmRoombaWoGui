#ifndef BEACONMANAGEMENTPROTOCOLSTATIC_HPP
#define BEACONMANAGEMENTPROTOCOLSTATIC_HPP
#include "baseS1ManagementProtocol.hpp"
#include <set>
//enum ProtocolStates{STARTED, FINISHED,WAITING_REPLY};

class BeaconManagementProtocolStatic: public BaseS1ManagementProtocol {
public:
    //roleInProtocol::Responder is only usable for S3Behaviour, pointer to ownerBehaviour is cast to S3beh
BeaconManagementProtocolStatic(RoleInProtocol roleInProtocol, BaseCommunicationBehaviour *ownerBeh);
...
#endif //BEACONMANAGEMENTPROTOCOLSTATIC_HPP
