...
enum class ProtocolStates{STARTED, FINISHED,WAITING_REPLY,WAITING_START_REQUEST,FIRST_MOVE,FIRST_MOVE_MEASUREMENT_RECEIVED,WAITING_DIST_MEASURE_RESULT,
                         ...
                         WAITING_ACKNOWLEDGE,MASTER_MEAS_RECEIVED,B1_MEAS_RECEIVED,B2_MEAS_RECEIVED,BEACONS_DEPLOYED};
enum class RoleInProtocol{INITIATOR, RESPONDER, SENDER, RECEIVER,STANDING_BEACON,MOVING_BEACON,S2BEACON,S3,BEACON,BEACON_MASTER,CLIENT, S2EXPLORERS};
