...
enum class ProtocolStates{STARTED, FINISHED,WAITING_REPLY,WAITING_START_REQUEST,FIRST_MOVE,FIRST_MOVE_MEASUREMENT_RECEIVED,WAITING_DIST_MEASURE_RESULT,
                          ...
                          WAITING_ACKNOWLEDGE,MASTER_MEAS_RECEIVED,B1_MEAS_RECEIVED,B2_MEAS_RECEIVED,BEACONS_DEPLOYED, QUERRY_WAITING_REPLY, REGROUPING,
                         GATHERING_BEACONS,SENDING_CORDINATES};
