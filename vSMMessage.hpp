...
enum class VSMSubsystems{NONE=DIRECT_ADRESS_MAX,S1,S2_BEACONS,S2_EXPLORERS,S3,S4,ROLE_CHECKING};
enum class Topics{NONE=DIRECT_ADRESS_MAX,BROADCAST,S1_,S2BEACONS_IN,S3_IN,S4_,BEACON_IN,S3_ROLE_CHECKING,CVAL_TO_S2,CVAL_INC_REQUEST,TWO_POINT_FORMATION_TO_MOVING,TWO_POINT_FORMATION_TO_STILL,SIZE_OF_THIS_ENUM};
enum class MessageContents{NONE,Test,DISTANCE_MEASUREMENT,ROLE_CHECK_WITH_S3,S3REPLY_TO_ROLE_CHECK,TPF_START,AGREE,FIRST_FORMATION_START,FORMATION_COMPLETED};
enum Behaviours{BEACON};// to remove
